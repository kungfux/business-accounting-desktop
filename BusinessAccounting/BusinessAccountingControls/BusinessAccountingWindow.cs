// Original implementation http://blog.magnusmontin.net/2013/03/16/how-to-create-a-custom-window-in-wpf/
...
namespace BusinessAccountingControls
{
    public class BusinessAccountingWindow : Window
    {
        static BusinessAccountingWindow()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(BusinessAccountingWindow),
                new FrameworkPropertyMetadata(typeof(BusinessAccountingWindow)));
        }

        public BusinessAccountingWindow()
            : base()
        {
